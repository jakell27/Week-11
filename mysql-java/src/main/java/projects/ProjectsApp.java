...
public class ProjectsApp {
	...
	private void updateProjectDetails() {
		...
		Integer estimatedHours = getIntInput("Enter the estimated hours [" + curProject.getEstimatedHours() + "]");

		Integer actualHours = getIntInput("Enter the actual hours [" + curProject.getActualHours() + "]");
